...
public class AgentControllerTest {
    ...
    public void before() throws Exception {
        baseUrl = new URL("http://localhost:" + port + "/com/bitcode/agent");
    }
    ...
    private Block mine(final String name) {
        final ResponseEntity<String> response = template.postForEntity(String.format("%s/mine?com.bitcode.agent=%s", baseUrl.toString(), name), null, String.class);
        try {
