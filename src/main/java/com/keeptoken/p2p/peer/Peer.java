package com.keeptoken.p2p.peer;
...
import com.keeptoken.p2p.peer.network.message.ping.CancelPongs;
import com.keeptoken.p2p.peer.network.message.ping.Ping;
import com.keeptoken.p2p.peer.network.message.ping.Pong;
import com.keeptoken.p2p.peer.service.ConnectionService;
import com.keeptoken.p2p.peer.service.LeadershipService;
import com.keeptoken.p2p.peer.service.PingService;
...
public class Peer {
    ...
    public Peer(Agent agent, Config config, ConnectionService connectionService, PingService pingService, LeadershipService leadershipService) {
        this.agent = agent;
        this.config = config;
    ...
    public void handleNewAgent(Connection connection) {
